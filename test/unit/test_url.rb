...
class TestUrl < Test::Unit::TestCase
  context '@client' do
    ...
    context '#title' do
      ...
      #TODO update the title once if it wasn't set upon initialization
      ...
      should "doesn't get info if the title is an empty string" do
        assert_equal '', BitlyOAuth::Url.new(@client, 'hash' => '9uX1TE', 'title' => '').title
      end
